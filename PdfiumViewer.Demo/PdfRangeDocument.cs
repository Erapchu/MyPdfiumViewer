...
namespace PdfiumViewer.Demo
{
    public class PdfRangeDocument : IPdfDocument
    {
        ...
        public PdfMatches Search(IEnumerable<string> texts, bool matchCase, bool wholeWord)
        {
            return TranslateMatches(_document.Search(texts, matchCase, wholeWord));
        }

        public PdfMatches Search(IEnumerable<string> texts, bool matchCase, bool wholeWord, int page)
        {
            return TranslateMatches(_document.Search(texts, matchCase, wholeWord, page));
        }

        public PdfMatches Search(IEnumerable<string> texts, bool matchCase, bool wholeWord, int startPage, int endPage)
        {
            return TranslateMatches(_document.Search(texts, matchCase, wholeWord, startPage, endPage));
        }
    }
}
