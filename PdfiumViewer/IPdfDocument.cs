...
namespace PdfiumViewer
{
    ...
    public interface IPdfDocument : IDisposable
    {
        ...
        PdfMatches Search(IEnumerable<string> texts, bool matchCase, bool wholeWord);
        PdfMatches Search(IEnumerable<string> texts, bool matchCase, bool wholeWord, int page);
        PdfMatches Search(IEnumerable<string> texts, bool matchCase, bool wholeWord, int startPage, int endPage);
